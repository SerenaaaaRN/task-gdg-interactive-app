...
const BannerHero = () => (
  ...
  >
    ...
    <div className="relative z-10 p-8 lg:p-16 flex flex-col h-full justify-center">
      ...
      <h1 className="text-5xl lg:text-7xl max-w-200 font-bold leading-tight mt-2 text-gray-900">Find Your Next Book</h1>
      ...
      <p className="max-w-xl pt-5 text-gray-700 text-sm md:text-base leading-relaxed">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum ipsa doloremque itaque, eligendi error laudantium
        libero quidem esse. Voluptates adipisci ex quis cumque aperiam distinctio.
      </p>
